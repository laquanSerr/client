...
import {
  ...
  xr,
  yi
} from "./chunk-FGNGAWSM.js";
import {
  Ct,
  oe
} from "./chunk-D6YPPLPS.js";
import {
  z
...
var dt = Jr((fe2, yt) => {
  (function(n2, s2) {
    ...
    let a3 = ne2, oe3 = class oe4 extends Error {
      constructor(t2) {
        super(`The parsing ended early. The next token was: ${s2(t2)}`), this.token = t2, Object.setPrototypeOf(this, oe4.prototype);
      }
      getToken() {
        return this.token;
      }
    };
    r(oe3, "EarlyEndOfParseError");
    let p3 = oe3, se2 = class se3 extends Error {
      constructor(t2, o3) {
        let i3 = `Unexpected type: '${t2.type}'.`;
        o3 !== void 0 && (i3 += ` Message: ${o3}`), super(i3), Object.setPrototypeOf(this, se3.prototype);
      }
    };
    ...
    let pr = {
      ...
      JsdocTypeSymbol: r((e) => {
        ...
        return (o3 == null ? void 0 : o3.type) === "JsdocTypeVariadic" && (o3.meta.position === "prefix" ? t2 = "..." : i3 = true, o3 = o3.element), (o3 == null ? void 0 : o3.type) === "JsdocTypeName" ? t2 += o3.value : (o3 == null ? void 0 : o3.type) === "JsdocTypeNumber" && (t2 += o3.value.toString()), i3 && (t2 += "..."), F2(`${e.value}(${t2})`);
      }, "JsdocTypeSymbol"),
...
var Nr = r((n2) => {
  switch (n2.type) {
    ...
    default:
      throw new oe({ type: n2, language: "Flow" });
  }
}, "convertSig");
var B = r((n2) => {
  var _a, _b, _c, _d;
  ...
  switch (typeof a3 < "u" && (p3.raw = a3), n2.name) {
    ...
    case "signature":
      return { ...p3, ...Nr(n2) };
    case "union":
      return ((_a = n2.elements) == null ? void 0 : _a.every(Sr)) ? { ...p3, name: "enum", value: (_b = n2.elements) == null ? void 0 : _b.map(Er) } : { ...p3, name: s2, value: (_c = n2.elements) == null ? void 0 : _c.map(B) };
    case "intersection":
      return { ...p3, name: s2, value: (_d = n2.elements) == null ? void 0 : _d.map(B) };
    default:
...
var Ar = r((n2) => {
  switch (n2.type) {
    ...
    default:
      throw new oe({ type: n2, language: "Typescript" });
  }
}, "convertSig");
var M = r((n2) => {
  var _a, _b, _c, _d;
  ...
  switch (typeof a3 < "u" && (p3.raw = a3), n2.name) {
    ...
    case "union":
      ...
      } : c2 = { ...p3, name: s2, value: (_c = n2.elements) == null ? void 0 : _c.map(M) }, c2;
    case "intersection":
      return { ...p3, name: s2, value: (_d = n2.elements) == null ? void 0 : _d.map(M) };
    default:
      return { ...p3, name: "other", value: s2 };
  }
}, "convert");
...
function Be({ startLine: n2 = 0, fence: s2 = "```", spacing: a3 = "compact", markers: p3 = v, tokenizers: c2 = [
  ...
  return function(P2) {
    ...
    for (let de2 of ut(P2)) {
      ...
      if (q2 === null)
        continue;
      let S2 = m2(q2), z4 = S2.slice(1).map(T2);
      b2.push({
        description: g2(S2[0], p3),
        tags: z4,
        source: q2,
        problems: z4.reduce((Te2, ge2) => Te2.concat(ge2.problems), [])
      });
    }
    return b2;
  };
...
function Pt(n2, s2) {
  if (n2 != null) {
    let { value: a3 } = n2;
    if (!K(a3))
      return wt(a3) ? w(s2 == null ? void 0 : s2.name, a3) : w(a3);
  }
  return null;
}
...
function ye(n2, s2) {
  ...
  if (s2 == null ? void 0 : s2.includesJsDoc) {
    ...
    let c2 = {
      ...p3,
      params: (_a = p3 == null ? void 0 : p3.params) == null ? void 0 : _a.map(
        (u2) => ({
...
var yn = r((n2) => {
  ...
  return n2.map((p3) => {
    var _a;
    let c2 = p3;
    return ((_a = p3.type) == null ? void 0 : _a.elements) && (c2 = {
      ...p3,
      type: {
        ...p3.type,
...
var Preview = ({ isLoading, isColumn, columns, children, withSource, withToolbar = false, isExpanded = false, additionalActions, className, layout = "padded", inline = false, ...props }) => {
  let [expanded, setExpanded] = (0, import_react.useState)(isExpanded), { source, actionItem } = getSource(withSource, expanded, setExpanded), [scale, setScale] = (0, import_react.useState)(1), previewClasses = [className].concat(["sbdocs", "sbdocs-preview", "sb-unstyled"]), defaultActionItems = withSource ? [actionItem] : [], [additionalActionItems, setAdditionalActionItems] = (0, import_react.useState)(additionalActions ? [...additionalActions] : []), actionItems = [...defaultActionItems, ...additionalActionItems], { window: globalWindow4 } = globalThis, copyToClipboard = (0, import_react.useCallback)(async (text) => {
    let { createCopyToClipboardFunction } = await import("./components-MOOOBFRI.js");
...
var pe3 = de(2);
function fe(e2) {
  return new RegExp("^" + (e2 === 1 ? ue2 : pe3));
}
var he = fe(1);
var me2 = fe(2);
function ge(e2) {
...
var je3 = /(javascript|vbscript|data(?!:image)):/i;
function He(e2) {
  try {
    let t2 = decodeURIComponent(e2).replace(/[^A-Za-z0-9/:]/g, "");
    if (je3.test(t2)) return null;
  } catch {
    return null;
  }
  return e2;
...
function Xe(n2 = "", i22 = {}) {
  function u2(e2, n3, ...r22) {
    ...
    }(e2, i22.overrides), t({}, n3, l2, { className: Qe(n3 == null ? void 0 : n3.className, l2.className) || void 0 }), ...r22);
  }
  function Z22(e2) {
    e2 = e2.replace(w2, "");
    let t2 = false;
    i22.forceInline ? t2 = true : i22.forceBlock || (t2 = W.test(e2) === false);
    let n3 = ae2(oe22(t2 ? e2 : `${ze(e2).replace(ie2, "")}
...
`, { inline: t2 }));
  ...
  i22.overrides = i22.overrides || {}, i22.sanitizer = i22.sanitizer || He, i22.slugify = i22.slugify || Le2, i22.namedCodesToUnicode = i22.namedCodesToUnicode ? t({}, o2, i22.namedCodesToUnicode) : o2, i22.createElement = i22.createElement || React20.createElement;
  let Q2 = [], V2 = {}, X22 = { [r2.blockQuote]: { match: De(p2), order: 1, parse(e2, t2, n3) {
...
` }, [r2.paragraph]: { match: Me2(Ne), order: 3, parse: Ge, render: (e2, t2, n3) => u2("p", { key: n3.key }, t2(e2.children, n3)) }, [r2.ref]: { match: Re2(P), order: 0, parse: (e2) => (V2[e2[1]] = { target: e2[2], title: e2[4] }, {}), render: qe2 }, [r2.refImage]: { match: Ie2(_2), order: 0, parse: (e2) => ({ alt: e2[1] || void 0, ref: e2[2] }), render: (e2, t2, n3) => V2[e2.ref] ? u2("img", { key: n3.key, alt: e2.alt, src: i22.sanitizer(V2[e2.ref].target, "img", "src"), title: V2[e2.ref].title }) : null }, [r2.refLink]: { match: Re2(F), order: 0, parse: (e2, t2, n3) => ({ children: t2(e2[1], n3), fallbackChildren: e2[0], ref: e2[2] }), render: (e2, t2, n3) => V2[e2.ref] ? u2("a", { key: n3.key, href: i22.sanitizer(V2[e2.ref].target, "a", "href"), title: V2[e2.ref].title }, t2(e2.children, n3)) : u2("span", { key: n3.key }, e2.fallbackChildren) }, [r2.table]: { match: De(H), order: 1, parse: Te, render(e2, t2, n3) {
    let r22 = e2;
...
`).replace(S, "").replace(G, "    ");
  ...
  return Q2.length ? u2("div", null, se2, u2("footer", { key: "footer" }, Q2.map(function(e2) {
    return u2("div", { id: i22.slugify(e2.identifier, Le2), key: e2.identifier }, e2.identifier, ae2(oe22(e2.footnote, { inline: true })));
  }))) : se2;
}
var index_modern_default = (t2) => {
  ...
  return React20.cloneElement(Xe(r22, i22), l2);
};
...
var LazyColorControl = (0, import_react.lazy)(() => import("./Color-AVL7NMMY-K5K5SOSQ.js"));
...
//# sourceMappingURL=chunk-ZVMNKI2X.js.map
