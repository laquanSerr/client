...
function expectTypes(obj, types) {
  ...
  types.sort();
  var str = types.map(function(t, index4) {
    var art = ~["a", "e", "i", "o", "u"].indexOf(t.charAt(0)) ? "an" : "a";
    var or = types.length > 1 && index4 === types.length - 1 ? "or " : "";
    return or + art + " " + t;
  }).join(", ");
...
function _mergeNamespaces2(n, m2) {
  m2.forEach(function(e) {
    e && typeof e !== "string" && !Array.isArray(e) && Object.keys(e).forEach(function(k) {
      if (k !== "default" && !(k in n)) {
        var d = Object.getOwnPropertyDescriptor(e, k);
...
var ReactIs2 = Object.fromEntries(reactIsMethods2.map((m2) => [m2, (v) => ReactIs182[m2](v) || ReactIs192[m2](v)]));
    ...
    var A = (r) => Array.isArray(r), d = (r) => typeof r == "function", Q = (r) => r.length === 0, W = (r) => typeof r == "number", K = (r) => typeof r == "object" && r !== null, X = (r) => r instanceof RegExp, b = (r) => typeof r == "string", h3 = (r) => r === void 0, Y = (r) => {
      ...
      return (e) => {
        ...
        return (t) => {
          ...
          if (c) return t.index = c.index, ((_a2 = c.output) == null ? void 0 : _a2.length) && t.output.push(...c.output), true;
          {
      ...
      for (; r <= e; ) n.push(r++);
      return n;
    }, or = (r, e, n) => S(r, e).map((a3) => String(a3).padStart(n, "0")), R = (r, e) => S(O(r), O(e)).map(ir), p3 = (r) => r, z2 = (r) => ur((e) => rr(e, r, { memoization: false }).join("")), ur = (r) => {
      const e = {};
      return (n) => e[n] ?? (e[n] = r(n));
    }, sr = i(/^\*\*\/\*$/, ".*"), cr = i(/^\*\*\/(\*)?([ a-zA-Z0-9._-]+)$/, (r, e, n) => `.*${e ? "" : "(?:^|/)"}${n.replaceAll(".", "\\.")}`), lr = i(/^\*\*\/(\*)?([ a-zA-Z0-9._-]*)\{([ a-zA-Z0-9._-]+(?:,[ a-zA-Z0-9._-]+)*)\}$/, (r, e, n, a3) => `.*${e ? "" : "(?:^|/)"}${n.replaceAll(".", "\\.")}(?:${a3.replaceAll(",", "|").replaceAll(".", "\\.")})`), y = i(/\\./, p3), pr = i(/[$.*+?^(){}[\]\|]/, (r) => `\\${r}`), vr = i(/./, p3), hr = i(/^(?:!!)*!(.*)$/, (r, e) => `(?!^${L(e)}$).*?`), dr = i(/^(!!)+/, ""), fr = l([hr, dr]), xr = i(/\/(\*\*\/)+/, "(?:/.+/|/)"), gr = i(/^(\*\*\/)+/, "(?:^|.*/)"), mr = i(/\/(\*\*)$/, "(?:/.*|$)"), _r = i(/\*\*/, ".*"), j = l([xr, gr, mr, _r]), Sr = i(/\*\/(?!\*\*\/)/, "[^/]*/"), yr = i(/\*/, "[^/]*"), N = l([Sr, yr]), k = i("?", "[^/]"), $r = i("[", p3), wr = i("]", p3), Ar = i(/[!^]/, "^/"), br = i(/[a-z]-[a-z]|[0-9]-[0-9]/i, p3), Cr = i(/[$.*+?^(){}[\|]/, (r) => `\\${r}`), Mr = i(/[^\]]/, p3), Er = l([y, Cr, br, Mr]), B2 = x([$r, tr(Ar), f3(Er), wr]), Pr = i("{", "(?:"), Or = i("}", ")"), Rr = i(/(\d+)\.\.(\d+)/, (r, e, n) => or(+e, +n, Math.min(e.length, n.length)).join("|")), zr = i(/([a-z]+)\.\.([a-z]+)/, (r, e, n) => R(e, n).join("|")), jr = i(/([A-Z]+)\.\.([A-Z]+)/, (r, e, n) => R(e.toLowerCase(), n.toLowerCase()).join("|").toUpperCase()), Nr = l([Rr, zr, jr]), I = x([Pr, Nr, Or]), kr = i("{", "(?:"), Br = i("}", ")"), Ir = i(",", "|"), Fr = i(/[$.*+?^(){[\]\|]/, (r) => `\\${r}`), Lr = i(/[^}]/, p3), Zr = E(() => F), Dr = l([j, N, k, B2, I, Zr, y, Fr, Ir, Lr]), F = x([kr, f3(Dr), Br]), Ur = f3(l([sr, cr, lr, fr, j, N, k, B2, I, F, y, pr, vr])), Vr = Ur, Gr = z2(Vr), L = Gr, Tr = i(/\\./, p3), qr = i(/./, p3), Hr = i(/\*\*\*+/, "*"), Jr = i(/([^/{[(!])\*\*/, (r, e) => `${e}*`), Qr = i(/(^|.)\*\*(?=[^*/)\]}])/, (r, e) => `${e}*`), Wr = f3(l([Tr, Hr, Jr, Qr, qr])), Kr = Wr, Xr = z2(Kr), Yr = Xr, $ = (r, e) => {
...
var parse = function(p3) {
  var _a2, _b;
  const root = ((_b = (_a2 = _PATH_ROOT_RE.exec(p3)) == null ? void 0 : _a2[0]) == null ? void 0 : _b.replace(/\\/g, "/")) || "";
...
var delimiter = (() => {
  var _a2;
  return ((_a2 = globalThis.process) == null ? void 0 : _a2.platform) === "win32" ? ";" : ":";
})();
...
function _mergeNamespaces3(n, m2) {
  m2.forEach(function(e) {
    e && typeof e !== "string" && !Array.isArray(e) && Object.keys(e).forEach(function(k) {
      if (k !== "default" && !(k in n)) {
        var d = Object.getOwnPropertyDescriptor(e, k);
...
var ReactIs3 = Object.fromEntries(reactIsMethods3.map((m2) => [m2, (v) => ReactIs183[m2](v) || ReactIs193[m2](v)]));
...
async function saveInlineSnapshots(environment, snapshots) {
  const MagicString = (await import("./magic-string.es-NZQQUGTY.js")).default;
  ...
  await Promise.all(Array.from(files).map(async (file) => {
    ...
    for (const snap of snaps) {
      ...
      replaceInlineSnap(code, s2, index4, snap.snapshot);
    }
...
function replaceObjectSnap(code, s2, index4, newSnap) {
...
function replaceInlineSnap(code, s2, currentIndex, newSnap) {
  ...
  if (!startMatch || startMatch.index !== (firstKeywordMatch === null || firstKeywordMatch === void 0 ? void 0 : firstKeywordMatch.index)) {
    return replaceObjectSnap(code, s2, index4, newSnap);
  }
...
var isAbsolute3 = function(p3) {
  return _IS_ABSOLUTE_RE3.test(p3);
};
...
function createExpectPoll(expect2) {
  return function poll(fn2, options = {}) {
    var _a2;
    const state = getWorkerState();
    const defaults = ((_a2 = state.config.expect) == null ? void 0 : _a2.poll) ?? {};
...
function recordAsyncExpect2(_test2, promise, assertion, error) {
  ...
  if (test7 && promise instanceof Promise) {
    ...
    test7.onFinished.push(() => {
      var _a2;
      if (!resolved) {
        const processor = ((_a2 = globalThis.__vitest_worker__) == null ? void 0 : _a2.onFilterStackTrace) || ((s2) => s2 || "");
        const stack = processor(error.stack);
        console.warn([
          `Promise returned by \`${assertion}\` was not awaited. `,
          "Vitest currently auto-awaits hanging assertions at the end of the test, but this will cause the test to fail in Vitest 3. ",
...
var SnapshotPlugin = (chai2, utils) => {
  ...
  utils.addMethod(chai2.Assertion.prototype, "toMatchInlineSnapshot", function __INLINE_SNAPSHOT__(properties, inlineSnapshot, message) {
    ...
    const isInsideEach = test7.each || ((_a2 = test7.suite) == null ? void 0 : _a2.each);
            ...
            timersPromisesModule.setInterval = (delay, value, options = {}) => ({
              [Symbol.asyncIterator]: () => {
                ...
                return {
                  next: async () => {
                    var _a2, _b;
                    if (((_a2 = options.signal) == null ? void 0 : _a2.aborted) && !hasThrown) {
                      hasThrown = true;
...
var FakeTimers = class {
  ...
  useFakeTimers() {
    ...
    if (!this._fakingTime) {
      ...
      if (((_b = (_a2 = this._userConfig) == null ? void 0 : _a2.toFake) == null ? void 0 : _b.includes("nextTick")) && isChildProcess()) throw new Error("process.nextTick cannot be mocked inside child_process");
...
var modifyErrorMessage = ({ task }) => {
  var _a2, _b;
  let meta = task.meta;
  if (task.type === "test" && ((_a2 = task.result) == null ? void 0 : _a2.state) === "fail" && meta.storyId && ((_b = task.result.errors) == null ? void 0 : _b[0])) {
